...
const MOCK_MEMBERS = [
  { id: 1, name: "T. Zulkarnaini Ampon Bang", dapil: "ACEH I", komisi: "Komisi VII", perolehan_suara: 82000, slug: "zulkarnaini", image: "https://www.dpr.go.id/setjen/view-foto-anggota/2024/1.jpg" },
  { id: 2, name: "Ilham Pangestu", dapil: "ACEH II", komisi: "Komisi IV", perolehan_suara: 110000, slug: "ilham-pangestu", image: "https://www.dpr.go.id/setjen/view-foto-anggota/2024/2.jpg" },
  { id: 3, name: "Samsul Bahri Tiyong", dapil: "ACEH II", komisi: "Komisi XIII", perolehan_suara: 95000, slug: "samsul-bahri", image: "https://www.dpr.go.id/setjen/view-foto-anggota/2024/3.jpg" },
  { id: 4, name: "Musa Rajekshah", dapil: "SUMATERA UTARA I", komisi: "Komisi V", perolehan_suara: 190000, slug: "musa-rajekshah", image: "https://www.dpr.go.id/setjen/view-foto-anggota/2024/4.jpg" },
  { id: 5, name: "Maruli Siahaan", dapil: "SUMATERA UTARA I", komisi: "Komisi XIII", perolehan_suara: 75000, slug: "maruli-siahaan", image: "https://www.dpr.go.id/setjen/view-foto-anggota/2024/5.jpg" },
  { id: 6, name: "Lamhot Sinaga", dapil: "SUMATERA UTARA II", komisi: "Komisi VII", perolehan_suara: 158973, slug: "lamhot-sinaga", image: "https://www.dpr.go.id/setjen/view-foto-anggota/2024/6.jpg" }
];
...
const VIP_ROSTER = [
  { role: "Ketua Fraksi", name: "M. Sarmuji", dapil: "Jawa Timur VI", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=200" },
  { role: "Sekretaris Fraksi", name: "Sari Yuliati", dapil: "Nusa Tenggara Barat II", img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80&w=200" },
  { role: "Bendahara Fraksi", name: "Puteri Anneta Komaruddin", dapil: "Jawa Barat VII", img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=200" }
];
...
// DATA MENTERI & KABINET
const KABINET_ROSTER = [
  { role: "Menteri Koordinator Bidang Perekonomian", name: "Airlangga Hartarto", type: "Menteri", img: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=200" },
  { role: "Menteri ESDM", name: "Bahlil Lahadalia", type: "Menteri", img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=200" },
  { role: "Menteri Perindustrian", name: "Agus Gumiwang Kartasasmita", type: "Menteri", img: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=200" },
  { role: "Menteri Komunikasi dan Digital", name: "Meutya Hafid", type: "Menteri", img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=200" },
  { role: "Menteri Kependudukan & Pembangunan Keluarga", name: "Wihaji", type: "Menteri", img: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=200" },
  { role: "Menteri ATR/BPN", name: "Nusron Wahid", type: "Menteri", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=200" },
  { role: "Menteri UMKM", name: "Maman Abdurahman", type: "Menteri", img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=200" },
  { role: "Menteri Pelindungan Pekerja Migran Indonesia", name: "Mukhtarudin", type: "Menteri", img: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=200" },
  { role: "Gubernur Lemhannas", name: "Ace Hasan Syadzily", type: "Setingkat Menteri", img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=200" },
  { role: "Wakil Menteri Pelindungan Pekerja Migran", name: "Christina Aryani", type: "Wakil Menteri", img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&q=80&w=200" },
  { role: "Wakil Menteri Perdagangan", name: "Dyah Roro Esty", type: "Wakil Menteri", img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=200" },
];

// --- KOMPONEN PLACEHOLDER PETA ---
const MapPlaceholder = () => (
  <div className="w-full h-[450px] bg-slate-100 rounded-[1.5rem] flex flex-col items-center justify-center border-2 border-dashed border-slate-200">
...
export const HomeView = () => {
  ...
  const komisiDistribution = useMemo(() => {
    ...
    return sorted.map(([name, count]) => ({
      name,
      count,
      percentage: Math.round((count / (totalTop || 1)) * 100)
    }));
  }, [members]);
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-24 md:pb-0 font-sans selection:bg-yellow-200 overflow-x-hidden">
      ...
      {/* CUSTOM STYLE UNTUK MARQUEE TICKER & SCROLLBAR */}
      ...
      {/* 2. QUICK STATS & SENTIMENT INDICATOR */}
      <div className="max-w-7xl mx-auto px-4 md:px-8 -mt-24 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-slate-100 flex flex-col group hover:-translate-y-1.5 transition-all duration-300">
            ...
            <div className="space-y-4 flex-1 justify-center flex flex-col">
               <div className="space-y-1.5">
                  <div className="flex justify-between text-[11px] font-bold uppercase tracking-tight">
                    <span className="flex items-center gap-1.5 text-emerald-600"><Smile className="w-3.5 h-3.5" /> Positif</span>
                    <span className="text-slate-800">{SENTIMENT_DATA.positive}%</span>
                  </div>
                  <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                    <div style={{ width: `${SENTIMENT_DATA.positive}%` }} className="h-full bg-emerald-500 rounded-full"></div>
                  </div>
               </div>
               <div className="space-y-1.5">
                  <div className="flex justify-between text-[11px] font-bold uppercase tracking-tight">
                    <span className="flex items-center gap-1.5 text-yellow-600"><Meh className="w-3.5 h-3.5" /> Netral</span>
                    <span className="text-slate-800">{SENTIMENT_DATA.neutral}%</span>
                  </div>
                  <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                    <div style={{ width: `${SENTIMENT_DATA.neutral}%` }} className="h-full bg-yellow-400 rounded-full"></div>
                  </div>
               </div>
               <div className="space-y-1.5">
                  <div className="flex justify-between text-[11px] font-bold uppercase tracking-tight">
                    <span className="flex items-center gap-1.5 text-rose-600"><Frown className="w-3.5 h-3.5" /> Negatif</span>
                    <span className="text-slate-800">{SENTIMENT_DATA.negative}%</span>
                  </div>
                  <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                    <div style={{ width: `${SENTIMENT_DATA.negative}%` }} className="h-full bg-rose-500 rounded-full"></div>
                  </div>
               </div>
            </div>
            <div className="mt-4 pt-4 border-t border-slate-50 flex items-center justify-between text-[10px] text-slate-400 font-bold uppercase tracking-widest">
               <span>Total Mentions: {SENTIMENT_DATA.totalMentions}</span>
            ...
            <div key={i} className="min-w-[200px] md:min-w-[240px] bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-5 border border-slate-700 shadow-xl relative overflow-hidden group snap-start cursor-pointer hover:-translate-y-1 transition-all duration-300">
               ...
               <div className="relative z-10 flex flex-col items-center text-center">
                 <img 
                    src={kabinet.img} 
                    alt={kabinet.name} 
                    className="w-16 h-16 md:w-20 md:h-20 rounded-full border-2 border-slate-600 object-cover mb-4 group-hover:scale-105 transition-transform duration-300 bg-slate-700" 
                 />
      ...
      {/* 5. MEDIA INSIGHT (Tampil di Homepage) */}
      <div className="max-w-7xl mx-auto px-4 md:px-8 mt-10 mb-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <button 
            ...
            className="text-xs font-bold text-slate-400 hover:text-slate-800 uppercase tracking-widest transition-colors flex items-center gap-1"
          >
        ...
        <div className="flex overflow-x-auto md:grid md:grid-cols-3 gap-6 pb-4 md:pb-0 no-scrollbar snap-x">
          {MOCK_NEWS.slice(0, 3).map((news: any) => (
            <a 
              href={news.url} 
              key={news.id} 
              target="_blank" 
              rel="noopener noreferrer"
              className="min-w-[280px] md:min-w-0 bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-[0_10px_30px_rgb(0,0,0,0.06)] hover:-translate-y-1 transition-all duration-300 group flex flex-col snap-start"
            >
              <div className="relative h-44 overflow-hidden bg-slate-100">
                ...
                <div className="absolute top-4 left-4">
                  <span className="bg-white/90 backdrop-blur-sm text-slate-800 text-[9px] font-black uppercase px-2.5 py-1.5 rounded-lg shadow-sm">
                    {news.tag}
                  </span>
                </div>
              </div>
              <div className="p-5 flex flex-col flex-1">
                ...
                <h3 className="font-bold text-slate-800 text-sm leading-snug mb-3 group-hover:text-blue-600 transition-colors line-clamp-3">
                  {news.title}
                </h3>
              </div>
            </a>
                ...
                {VIP_ROSTER.map((vip, i) => (
                  <div key={i} className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-6 border border-slate-700 shadow-xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-5 relative z-10">
                      <img src={vip.img} alt={vip.name} className="w-20 h-20 rounded-2xl border-2 border-slate-600 bg-slate-700 object-cover" />
                      <div>
              ...
              <div className="flex flex-wrap gap-4 mt-2">
                {komisiDistribution.map((kd, i) => (
                  <div key={i} className="flex items-center gap-2 text-xs font-semibold text-slate-600">
                    <span className={`w-2.5 h-2.5 rounded-sm ${barColors[i]}`}></span>
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-8 bg-white p-2 rounded-3xl border border-slate-200 shadow-sm">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-transparent rounded-2xl text-sm font-semibold text-slate-800 focus:outline-none"
                  value={search}
              ...
              {filteredMembers.map((member: any) => (
                <div key={member.id} className="bg-white rounded-[2rem] overflow-hidden border border-slate-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_15px_35px_rgb(0,0,0,0.08)] hover:-translate-y-2 transition-all duration-300 group cursor-pointer">
                  ...
                  <div className="p-6 relative">
                    <div className="absolute -top-6 right-5 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg border border-slate-50 text-slate-300 group-hover:text-yellow-600 transition-all duration-300 z-30">
                    ...
                    <div className="flex justify-between items-center pt-4 border-t border-slate-100">
                      <div>
                        ...
                        <p className="font-black text-slate-800 text-base">{member.perolehan_suara.toLocaleString('id-ID')}</p>
                      </div>
                    </div>
                  </div>
                </div>
               ...
               <div className="lg:col-span-1">
                  <div className="bg-white rounded-[2rem] p-6 md:p-8 border border-slate-100 shadow-sm sticky top-28">
                    <div className="flex items-center justify-between mb-8">
                      ...
                      <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center"><Calendar className="w-5 h-5 text-slate-400" /></div>
                    </div>
      ...
      <div className="md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-[340px] z-[100]">
        <div className="bg-slate-900/95 backdrop-blur-xl border border-slate-700 shadow-2xl rounded-[2rem] p-2 flex items-center justify-between relative">
            ...
            <div className="relative -top-8 px-2"><div className="w-14 h-14 bg-gradient-to-b from-yellow-300 to-yellow-500 rounded-full flex items-center justify-center shadow-lg border-[5px] border-[#F8FAFC]"><Zap className="w-6 h-6 text-slate-900" fill="currentColor" /></div></div>

...
export const ThreadsIcon = ({ size = 20 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M19.25 10c0-4.42-3.58-8-8-8s-8 3.58-8 8 3.58 8 8 8c1.54 0 2.97-.44 4.18-1.21L19.25 21" />
    <path d="M11.25 6c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4" />
    <path d="M15.25 10c0-1.1-.9-2-2-2" />
  </svg>
);
